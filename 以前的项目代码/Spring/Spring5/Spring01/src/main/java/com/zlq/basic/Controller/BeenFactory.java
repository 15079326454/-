package com.zlq.basic.Controller;
...
//    第二步  文件内容  封装 Properties集合中key = userService value = com.BeenFactory.basic.Service.ServiceImpl.UserServiceImpl
    try {
 ...
 /*
    ...
    /**
     *
     * @param key 小配置文件中的key,[userDao,userService]
     * @return
     */
